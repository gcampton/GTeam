...
| `product-context` | `specialists/product-context/SKILL.md` | Build or update the shared product-context file (ICP, positioning, customer language) |
| `pricing-strategy` | `specialists/pricing-strategy/SKILL.md` | SaaS tier design, value metric selection, price points, pricing page optimisation |
| `revops` | `specialists/revops/SKILL.md` | Lead lifecycle, scoring, routing, pipeline hygiene, CRM automation, RevOps metrics |
