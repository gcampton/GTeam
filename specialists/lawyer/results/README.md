...
This directory stores real-world outcomes from applying GTeam lawyer recommendations.
...
## Context
- **Contract type:** [employment / SaaS / NDA / partnership / vendor / other]
- **Governing jurisdiction:** [specific state/country law that applies]
- **Deal value (approx):** [$ range or "not applicable"]
- **Starting position:** [e.g. draft stage, disputed clause, pre-litigation]
