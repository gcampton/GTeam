...
- Do NOT Read entire reference files. Use Grep to search `~/.claude/skills/gteam/specialists/brand-strategist/references/` for specific keywords relevant to the task.
- Check `~/.claude/skills/gteam/specialists/brand-strategist/results/` — if result entries exist, Grep them for industry and maturity-stage patterns.
