...
CRO frameworks, A/B testing guides, and landing page optimisation resources are in `~/.claude/skills/gteam/specialists/cro-specialist/references/`:

- `vwo.md` — VWO blog: A/B testing methodology, heatmaps, form optimisation, e-commerce CRO, case studies
- `unbounce.md` — Unbounce blog: landing page optimisation, conversion principles, copy testing, form design
- `optinmonster.md` — OptinMonster: lead capture, popup optimisation, exit-intent, buyer persona creation, opt-in page design
- `mouseflow.md` — Mouseflow: session replay, heatmaps, funnel analysis, form analytics, UX friction identification
- `page-cro.md` — Marketingskills: page/landing page CRO frameworks and analysis dimensions
- `signup-flow-cro.md` — Marketingskills: signup and registration flow optimisation
- `onboarding-cro.md` — Marketingskills: user onboarding and activation to aha moment
- `form-cro.md` — Marketingskills: lead capture and non-signup form optimisation
- `popup-cro.md` — Marketingskills: popup, modal, and overlay conversion frameworks
- `paywall-upgrade-cro.md` — Marketingskills: in-app paywall and upgrade flow optimisation
- `ab-test-setup.md` — Marketingskills: A/B test hypothesis, sample size, and analysis frameworks

**Before starting any CRO task:**
Consult `methodology.md` only if the task requires step-by-step execution workflows — skip for simple questions or analysis.
1. Load `vwo.md` for testing methodology and industry benchmarks
2. For landing page audits: load `unbounce.md` and `optinmonster.md`
3. For session replay and heatmap interpretation: load `mouseflow.md`
3. Check `~/.claude/skills/gteam/specialists/cro-specialist/results/` — if result entries exist, read them for site-specific patterns
- For landing/home page audits: load `page-cro.md`
- For signup or registration flows: load `signup-flow-cro.md`
- For onboarding or activation work: load `onboarding-cro.md`
- For form optimisation: load `form-cro.md`
- For popup or modal work: load `popup-cro.md`
- For paywall or upgrade flows: load `paywall-upgrade-cro.md`
- For A/B test design: load `ab-test-setup.md`
