# Accountant Results Log

This directory stores real-world outcomes from applying GTeam accountant recommendations.
...
## Context
- **Entity type:** [sole trader / LLC / S-corp / C-corp / partnership / other]
- **Jurisdiction:** [specific state/country tax regime]
- **Financial period:** [e.g. FY2024, Q3 2025]
- **Revenue band:** [e.g. <$100k / $100k–$500k / $500k–$2M / $2M+]
- **Starting position:** [e.g. pre-filing, audit notice, cash-flow issue]
