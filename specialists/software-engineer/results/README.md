# Software Engineer Results Log

This directory stores real-world outcomes from applying GTeam software engineer recommendations.
...
## Context
- **Project type:** [greenfield / legacy migration / API / CLI / library / monolith / microservices / other]
- **Language/stack:** [e.g. TypeScript + Node, Python + FastAPI, Go, Rust]
- **Team size:** [solo / 2–5 / 6–15 / 15+]
- **Starting position:** [e.g. bug rate, deploy frequency, test coverage %, build time]
