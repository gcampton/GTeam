...
|---|---|---|
| content-strategy.md | framework | Social media content strategy covering the 80/20 ratio, series formats, and repurposing chains |
| hootsuite.md | framework | Scraped Hootsuite blog index with social media management and marketing articles |
...
| platform-algorithms.md | framework | Deep-dive into how each major platform's algorithm works (X, LinkedIn, Instagram, TikTok, YouTube) with ranking signals, optimisation tactics, and before/after examples |
